...
public class LetterScript : MonoBehaviour
{
    ...
    private LineColliderScript LCScript;
    ...
    void Start()
    {
        ...
        LCScript = FindAnyObjectByType<LineColliderScript>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if(collision.CompareTag("Player"))
        {
            ...
            //SScript.Score += 50;
            //Debug.Log("SCORE: " + SScript.Score + "!!!!!!!!!");
            //LCScript.CollidedWithPlayer = false;
        }
    }

    private void ChooseSound()
    {
        LetterIndex = TileScript.Letters.IndexOf(gameObject);
